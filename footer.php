	...
	<footer id="footer">
		...
		<?php if ( has_nav_menu( 'footer' ) ): ?>
			<nav class="nav-container group" id="nav-footer">
				...
				<div class="nav-wrap container-inner"><?php wp_nav_menu( array('theme_location'=>'footer','menu_class'=>'nav group','container'=>'','menu_id'=>'','fallback_cb'=>false) ); ?></div>
			</nav><!--/#nav-footer-->
		<?php endif; ?>
				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="copyright">
							...
							<?php else: ?>
								<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'agnar' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'agnar' ); ?></p>
							<?php endif; ?>
						</div><!--/#copyright-->
						
						<?php if ( get_theme_mod( 'credit', 'on' ) == 'on' ): ?>
						<div id="credit">
							<p><?php esc_html_e('Powered by','agnar'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','agnar'); ?> <a href="http://alx.media" rel="nofollow">Alx</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
